...
and numeric bounds over stdin; its versioned result is size-bounded and treated as untrusted by
the parent. The AI worker gets a non-secret request, explicit credentials via
